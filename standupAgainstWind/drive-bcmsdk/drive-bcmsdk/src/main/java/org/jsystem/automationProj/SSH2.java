 ...
 */
public class SSH2 extends Terminal {
	...
	public SSH2(String hostnameP, String usernameP, String passwordP) {
	 ...
	 */
	public SSH2(String hostnameP, String usernameP, String passwordP, int destinationPort) {
		this(hostnameP, usernameP, passwordP, -1, destinationPort, true);
	}
	
	
	public SSH2(String hostnameP, String usernameP, String passwordP, int sourceTunnelPort, int destinationTunnelPort) {
		this(hostnameP, usernameP, passwordP, sourceTunnelPort, destinationTunnelPort, true);
	}

	public SSH2(String hostnameP, String usernameP, String passwordP, int sourceTunnelPort, int destinationTunnelPort, boolean _xtermTerminal) {
		super();
		hostname = hostnameP;
		username = usernameP;
		password = passwordP;
	...
	public void connect() throws IOException {
		...
		if (passAuthentication) {
			System.out.println("passAuthentication true");
			try {
				isAuthenticated = conn.authenticateWithPassword(username, password);
			} catch (Exception e) {
				System.out.println("Exception isAuthenticated false");
	...
	class InteractiveLogic implements InteractiveCallback {
		...
		public String[] replyToChallenge(String name, String instruction, int numPrompts, String[] prompt, boolean[] echo) throws IOException {
			...
			System.out.println("InteractiveCallback");
